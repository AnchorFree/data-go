...
func NewKafkaProxy(cl client.KafkaClient, cfg Props, prom *prometheus.Registry) *KafkaProxy {
...
func (kp *KafkaProxy) GetClient() client.KafkaClient {
	return kp.client
}
